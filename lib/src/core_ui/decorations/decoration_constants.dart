...
Decoration broadShadowsCard(
  ...
  shape: Superellipse.all(cornerRadius, side: side),
  ...
  SmoothGradient({
    ...
    int steps = 16,
         ...
         colors: List.generate(
           steps + 1,
           (i) => Color.lerp(fromColor, toColor, i / steps)!,
         ),
         stops: List.generate(
           steps + 1,
           (i) => curve.transform(from + i / steps * to),
         ),
       );
}
